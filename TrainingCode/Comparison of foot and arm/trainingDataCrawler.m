...
train_x=fopen('/home/student/train_x_5_10f_foot.txt','a');
train_y=fopen('/home/student/train_y_5_10f_foot.txt','a');
    ...
    for j=3:floor(length(files)/10*9)
        ...
        for x=11:(size(channels,1)-10)
           ...
           fprintf(train_y,'%.15f %.15f %.15f %.15f %.15f %.15f\n',...
               channels_normal(x,25),channels_normal(x,26),channels_normal(x,27),...
               channels_normal(x,28),channels_normal(x,29),channels_normal(x,30));
        end
    end
    %{
